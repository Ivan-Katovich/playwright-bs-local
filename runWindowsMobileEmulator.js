...
const caps = {
    ...
    // 'browserstack.tunnelIdentifier': 'tunnel_connection_name',
...
(async () => {
    ...
    await wait(async () => await menu.count() > 0);
    console.log(await menu.isVisible());
    await menu.click();
